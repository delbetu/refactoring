# Code smell large method (statement)
# Decompose it into smaller pieces.
# Identify a logical clump of code and extract method.
# switch case is a good chunk of code.
class Customer
  ...
  def amount_for(rental)
    ...
    when Movie::CHILDRENS
      ...
      if (rental.days_rented > 3)
        this_amount += (rental.days_rented - 1) * 1.5
      end
    end
    this_amount
  end
