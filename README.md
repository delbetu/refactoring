...
## Movies exercise
The problem is prsented in Martin Fowler's `Refactoring` book.
...
It calculates the charges, which depend on how long the movie is rented, and identifies the type of
movie.
